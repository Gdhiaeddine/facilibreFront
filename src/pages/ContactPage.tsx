    ...
    <PageLayout>
      <div className="bg-gray-50 py-12 md:py-20">
        <div className="container">
          <h1 className="text-4xl md:text-5xl font-bold text-center mb-8">{t('contact')}</h1>
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <address className="not-italic text-muted-foreground">
                    Route N 05 en face la poste
                    <br />
                    Bourdj Bouariridj 34006 El Achir, Algeria
                  </address>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">0770 50 55 60</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="font-medium">{t('emailAddress')}</h3>
                  <p className="text-muted-foreground">mtec.bba.dz@gmail.com</p>
                </div>
              </div>
              ...
              <div className="pt-4 border-t">
                ...
                <div className="flex space-x-4">
                  <a href="https://www.facebook.com/mtfc.dz" className="text-gray-600 hover:text-primary">
